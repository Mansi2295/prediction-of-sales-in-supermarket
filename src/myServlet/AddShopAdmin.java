...
/**
 * Servlet implementation class AddShopAdmin
 */
@WebServlet("/AddShopAdmin")
public class AddShopAdmin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ps1=conn.prepareStatement("insert into shop values(?,?,?,?,?,?)");
