           ...
           <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          <tbody>
                                                  ...
                                                  <td><a href="updateStock.jsp?id=<%=resultSet.getString("id")%>">Update</a></td>
													<td><a href="deleteProduct.jsp?id=<%=resultSet.getString("id") %>" onclick="return confirm_alert(this);">Delete</a></td>
