			...
			<div class="mother-grid-inner">
				...
				<div class="agileinfo-grap">
					<div class="agileits-box">
							 ...
							 <form action="AddShopAdmin" method="post">
    						...
    						<label for="inputEmail3" class="col-sm-3 form-control-label">Name</label>
                	  		<div class="col-sm-9">
                    		<input type="text" cols="7" rows="1" class="form-control" name="nameTxt" placeholder="Enter Shop Admin Name" required></input>
                 			</div>
               			 	</div>
    						...
    						<label for="inputEmail3" class="col-sm-3 form-control-label">Email</label>
                  			<div class="col-sm-9">
                    		<input type="email" cols="7" rows="1" class="form-control" name="emailTxt" placeholder="Enter Shop Admin Email-ID" onblur="validateEmail(this);" required></input>
                 			</div>
                			</div> 
    						...
    						<label for="inputEmail3" class="col-sm-3 form-control-label">Password</label>
                  			<div class="col-sm-9">
             		 		<input type = "password" cols="7" rows="1" class="form-control" name="passwordTxt" placeholder="Enter Password" required></input>
                  			</div>
                			</div>
                			...
                			<div class="form-group row">
                			<input type="hidden" name="action" value="add"/>
    						<label for="inputEmail3" class="col-sm-3 form-control-label">City</label>
                	  		<div class="col-sm-9">
                    		<input type="text" cols="7" rows="1" class="form-control" name="cityTxt" placeholder="Enter Name of city" required></input>
                 			</div>
               			 	</div>
